...
adjAAPL_wMA <- na.omit(merge.xts(adjAAPL, ma5, ma9))  # Merge adjAAPL and its MA5 to a single object
...
## Fit Holt-Winter ES to AAPL data and compare its accuracy of the fit with MA(5) and MA(9).  
...
adjAAPL_wHoltES <- merge.xts(adjAAPL, holt1ES)  # Merge Holt ES to AAPL daily price xts object
...
## If SE of the forecast is 1.8, write 95% confidence interval for the forecast of November 2014.  
