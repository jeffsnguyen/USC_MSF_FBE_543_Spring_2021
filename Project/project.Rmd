...
```{r}
ggtsdisplay(holdings, main="Portfolio Holdings Daily Closing Price", plot.type="scatter")
```
...
```{r}
IRF <- irf(var, impulse.variable = 2, response.variable = 1,  t = NULL, nhor = 20, scenario = 2, draw.plot = TRUE)
IRF
```
...
```{r}
IRF_holdingsGSPC <- irf(var_holdingsGSPC, impulse.variable = 2, response.variable = 1,  t = NULL, nhor = 20, scenario = 2, draw.plot = TRUE)
IRF_holdingsGSPC
```
