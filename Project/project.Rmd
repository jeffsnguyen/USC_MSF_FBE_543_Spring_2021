...
plot(ra, main="Portfolio Holdings Monthly Returns Moving Average Order of 5 Forecast", type = "l")
lines(ma5, col="red")
```
...
plot(ra, main="Portfolio Holdings Monthly Returns Moving Average Order of 15 Forecast", type = "l")
lines(ma15, col="red")
```
...
```{r}
#Holt Trend Model
#Forecast equation ŷft+h = lt + hbt
#Level equation lt = αyt + (1−α)(lt−1 + bt−1), α Smoothing coef for Level
#Trend equation bt = β(lt − lt−1) + (1−β)bt−1 , β Smoothing coef for Trend
...
```{r}
hws2 <- hw(rHoldings,seasonal="multiplicative")
