...
# Plot S&P 500
plot(as.zoo(price_compare[, "GSPC.Adjusted"]), screens = 1, main = "S&P 500 and TSLA Adjusted Price Overlay", 
...
plot(as.zoo(price_compare[, "TSLA.Adjusted"]), screens = 1, xaxt = "n", yaxt = "n", xlab = "", ylab = "", col = "Blue")

# Add right-handed axis to display AAPL price
axis(4)

# Add legend
legend("topleft", c("S&P 500 Adjusted Price", "TSLA Adjusted Price"), lty = 1:1, cex = 0.75, fill = c("red", "blue"))
```
...
colnames(ar_plot) <- "AR"
chartSeries(ar_plot, name="Abnormal Returns", type='line', theme=chartTheme("white"))
```
...
chartSeries(cum, name="Cumulative Abnormal Returns", type='line', theme=chartTheme("white"))
```
