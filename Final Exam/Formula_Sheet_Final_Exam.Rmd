...
|----------------------------------------------------|------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Conditional Mean $E[Y_{t+1} |\Omega]$              | $E[Y_{t+1}|\Omega] = `r gamma_0` + `r gamma_1` Y_{t} = `r y_tPlus1`$                                | $E[Y_{t+1}|\Omega] \pm 1.96 \sqrt{Var[Y_{t+1}|\Omega]} = `r y_tPlus1` \pm 1.96 \sqrt{`r var_y_tPlus1`}$                                                           |
| Conditional Mean $E[Y_{t+2}|\Omega]$              | $E[Y_{t+2}|\Omega] = `r gamma_0` + `r gamma_1` Y_{t+1} = `r y_tPlus2`$                              | $E[Y_{t+2}|\Omega] \pm 1.96 \sqrt{Var[Y_{t+2}|\Omega]} = `r y_tPlus2` \pm 1.96 \sqrt{`r var_y_tPlus2`}$                           |
| Conditional Mean $E[Y_{t+3}|\Omega]$              | $E[Y_{t+3}|\Omega] = `r gamma_0` + `r gamma_1` Y_{t+2} = `r y_tPlus3`$                              | $E[Y_{t+2}|\Omega] \pm 1.96 \sqrt{Var[Y_{t+3}|\Omega]} = `r y_tPlus2` \pm 1.96 \sqrt{`r var_y_tPlus3`}$  |
| Unconditional Mean $Y_{LR}$                        | $Y_{LR} = \frac{\gamma_0}{1 - \gamma_1}$ = `r y_LR`                                                  | $Y_{LR} \pm 1.96 \sqrt{Var[Y_{LR}]} = `r y_LR` \pm 1.96 \sqrt{`r var_y_LR`}$                            |
| Conditional Variance $Var[Y_{t+1}|\Omega]$        | $Var[Y_{t+1}|\Omega] = E[\epsilon_{t+1}^2\|\Omega] = `r var_y_tPlus1`$                              |                                                                                                                                                                       |
| Conditional Variance $Var[Y_{t+2}|\Omega]$        | $Var[Y_{t+2}|\Omega] = (1+\gamma_1^2) E[\epsilon_{t+2}^2\|\Omega] = `r var_y_tPlus2`$               |                                                                                                                                                                       |
| Conditional Variance $Var[Y_{t+3}|\Omega]$          | $Var[Y_{t+3}|\Omega] = (1+\gamma_1^2+\gamma_1^4) E[\epsilon_{t+3}^2\|\Omega] = `r var_y_tPlus3`$      |                                                                                                                                                                       |
| Unconditional Variance $Var[Y_{LR}]$               | $Var[Y_{LR}] = \frac{\sigma_{\epsilon}^2}{1-\gamma_1^2} = `r var_y_LR`$                              |                                                                                                                                                                       |
| Conditional Variance $E[\epsilon_{t+1}^2|\Omega]$ | $E[\epsilon_{t+1}^2|\Omega] = `r a_0` + `r a_1` \sigma^2_{\epsilon} = `r epsilonSq_tPlus1`$         |                                                                                                                                                                       |
| Conditional Variance $E[\epsilon_{t+2}^2|\Omega]$ | $E[\epsilon_{t+2}^2|\Omega] = `r a_0` + `r a_1` E[\epsilon_{t+1}^2|\Omega] = `r epsilonSq_tPlus2`$ |                                                                                                                                                                       |
| Conditional Variance $E[\epsilon_{t+3}^2|\Omega]$ | $E[\epsilon_{t+3}^2|\Omega] = `r a_0` + `r a_1` E[\epsilon_{t+1}^2|\Omega] = `r epsilonSq_tPlus3`$ |                                                                                                                                                                       |
